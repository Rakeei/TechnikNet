...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.getenv('DB_PASSWORD', 'sG7aJx2SAZHxB137TPI0r3Ma3R7L7a1JByXhpnwyqFvN7NCqTn'),
...
AXES_FAILURE_LIMIT = 3  # After 3 failed login attempts
AXES_COOLOFF_TIME = 1  # 1 hour lockout period
