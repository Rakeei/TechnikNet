...
def property_list(request):
    ...
    per_page = request.GET.get('per_page', '50')  # پیش‌فرض 50
    
    # Validate per_page
    if per_page == 'all':
        per_page_int = properties.count()  # تمام رکوردها
    else:
        try:
            per_page_int = int(per_page)
            # محدود کردن به حداکثر 1000
    ...
    context = {
        ...
        'per_page': per_page,  # ⭐ ارسال به template
    }
